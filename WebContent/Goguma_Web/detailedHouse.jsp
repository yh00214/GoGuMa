...
<%
	String id = request.getParameter("regiNum");
	//String id= "34121162";
...
%>
        ...
        <div class = "col-md-5" style = "display : inline-flex; max-width : 100%;">
            ...
            <script>
                var mapOptions = {
                    center: new naver.maps.LatLng(<%=re.getPositionX()%>,<%=re.getPositionY()%> ),
                    zoom: 18
                };
                ...
                var marker = new naver.maps.Marker({
                    position: new naver.maps.LatLng(<%=re.getPositionX()%>,<%=re.getPositionY()%>),
                    map: map
                });
            </script>
        </div>  
